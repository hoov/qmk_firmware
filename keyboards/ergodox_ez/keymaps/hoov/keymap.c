...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    KC_ESCAPE,      KC_A,           KC_S,           KC_D,           KC_F,           KC_G,                                                                           KC_H,           KC_J,           KC_K,           KC_L,           LT(2,KC_SCOLON),LGUI_T(KC_QUOTE),
    KC_LSHIFT,      KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,           LGUI(KC_LSHIFT),                                KC_MEH,         KC_N,           KC_M,           KC_COMMA,       KC_DOT,         RCTL_T(KC_SLASH),KC_RSHIFT,
    MO(1),          KC_LCTRL,       KC_LALT,        KC_LGUI,        LCTL(KC_B),                                                                                                     KC_LEFT,        KC_UP,          KC_DOWN,        KC_RIGHT,       TT(1),
                                                                                                    KC_HOME,        KC_END,         KC_DELETE,      KC_INSERT,
                                                                                                                    KC_PGUP,        KC_CAPSLOCK,
                                                                                    KC_SPACE,       KC_BSPACE,      KC_PGDOWN,      KC_RCTRL,       KC_ENTER,       KC_SPACE
  ),
    ...
    switch (layer) {
      case 0:
        if(!disable_layer_color) {
          ...
          rgblight_sethsv_noeeprom(0,0,170);
        }
        break;
      case 1:
        if(!disable_layer_color) {
